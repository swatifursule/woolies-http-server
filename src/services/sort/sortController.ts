...
export async function getProducts() {
	return axios({
		url:
			'http://dev-wooliesx-recruitment.azurewebsites.net/api/resource/products?token=b701ad68-57e0-46b2-aaec-77d58e86cea1',
		method: 'get'
	})
}
export async function getShopperHistory() {
	return axios({
		url:
			'http://dev-wooliesx-recruitment.azurewebsites.net/api/resource/shopperHistory?token=b701ad68-57e0-46b2-aaec-77d58e86cea1',
		method: 'get'
	})
}
						...
						custProducts.forEach((prod: any) => {
							...
							if (index == -1) {
								...
								allProducts[index].quantity =
									allProducts[index].quantity + prod.quantity
							}
						})
					})
